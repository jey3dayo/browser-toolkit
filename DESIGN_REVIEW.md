...
This guide does not replace `AGENTS.md`, `docs/style-management.md`, or the CSS token implementation in `src/styles/tokens/`.
...
1. `AGENTS.md`, including its Source Of Truth table, and the owner documents it names.
