...
export type PrimitiveToken =
  (typeof primitiveTokens)[keyof typeof primitiveTokens];
...
export type SemanticToken =
  (typeof semanticTokens)[keyof typeof semanticTokens];
...
export type ComponentToken =
  (typeof componentTokens)[keyof typeof componentTokens];
