    ...
    translation: {
      ...
      searchBlocklist: {
        countBar: {
          hide: "非表示にする",
          reveal: "表示",
          summary: "{{count}}件のサイトを非表示にしました",
        },
        description:
          "検索結果から非表示にしたいサイトをパターンで登録できます（例: example.com）。この端末のみに保存され、同期されません。",
        dialog: {
          blockAction: "ブロック",
          cancelAction: "キャンセル",
          detailsEngine: "検索エンジン",
          detailsTitle: "詳細",
          detailsTitleField: "タイトル",
          detailsUrl: "URL",
          hostnameFallback: "このサイト",
          openSettingsAria: "検索結果ブロックの設定を開く",
          rulesToAdd: "追加するルール",
          rulesToAddPlaceholder: "1行につき1件のパターンを入力",
          rulesToRemove: "解除するルール",
          rulesToRemoveEmpty: "(なし)",
          titleBlock: "このサイトをブロック",
          titleUnblock: "このサイトのブロックを解除",
          triggerAria: "この検索結果をブロック",
          unblockAction: "解除する",
        },
        empty: "まだルールが登録されていません",
        errors: {
          addFailed: "追加に失敗しました",
          corrupted:
            "ルールデータが壊れているか上限を超えています。一覧を確認してください。",
          corruptedCount:
            "{{count}}件のルールが読み取れず、検索結果には適用されていません。読み取れないルールは下の一覧に表示されます。一覧から削除するか、正しいパターンへ修正してください。",
          deleteFailed: "削除に失敗しました",
          patternRequired: "パターンを入力してください",
          saveFailed: "保存に失敗しました",
        },
        info: {
          duplicate: "既に同じパターンが登録されています",
        },
        listAria: "登録済みブロックルール",
        success: {
          added: "追加しました",
          deleted: "削除しました",
          updated: "更新しました",
